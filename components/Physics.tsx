                  ...
                  {[
                    {
                      ...
                      title: "NPU Edge-State",
                      desc: "Local inference allows for millisecond weapon detection without cloud handshaking or cellular dependency."
                    },
                    {
                      icon: <Radio className="text-[#00FF41] flex-shrink-0" />,
                      title: "FIPS 140-2 Sync",
