      ...
      >
        ...
        <div className="relative w-full max-w-7xl mx-auto flex flex-col items-center justify-center py-24 my-6">
          ...
          <div className="relative z-10 flex flex-col items-center leading-[0.82] tracking-[-0.05em] uppercase font-black">
            <h1 className="text-[clamp(3.5rem,11vw,9rem)] text-white">Every Officer.</h1>
            <h1 className="text-[clamp(3.5rem,11vw,9rem)] text-neutral-500">Every Call.</h1>
            <h1 className="text-[clamp(3.5rem,11vw,9rem)] text-white hover:text-[#FF3B30] hover:scale-105 transition-all duration-700 ease-out">Never Alone.</h1>
          </div>
        </div>
