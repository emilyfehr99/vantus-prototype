        ...
        >
          ...
          <div className="grid gap-10">
            {[
              ...
              { icon: <ShieldAlert size={20} />, title: "Cognitive Fatigue", desc: "Managing suspects while coordinating dispatch causes dangerous oversight." },
              { icon: <Clock size={20} />, title: "30s vs 0.8s", desc: "Vantus triggers backup 30x faster than manual radio transmission." }
            ].map((item, i) => (
              <MotionDiv 
                key={i} 
