            ...
            <div className="max-w-7xl mx-auto">
                <div className="mb-16">
                    ...
                    <p className="mt-6 text-neutral-400 font-mono text-sm max-w-2xl leading-relaxed">
                        Real-time situational awareness for watch commanders and dispatch. Vantus aggregates multi-modal field data into an actionable, low-latency command view without visual clutter.
                    </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <DashboardFeature
                        ...
                        desc="Color-coded unit tracking with active alerts overlay. Instantly locate units engaged in high-stress or Tier 2/3 incidents."
                        delay={0.1}
                    />
                    <DashboardFeature
                    ...
                    <DashboardFeature
                        ...
                        desc="Immutable ledger of all autonomous RoIP injections and CAD interactions generated by the system during critical events."
                        delay={0.4}
                    />
                    <DashboardFeature
                        icon={<MessageSquare />}
